...
export const connectToSocket = (server) => {
    ...
    io.on("connection", (socket) => {
        ...
        socket.on("chat-message", (data, sender) => {
            // FIXED: Corrected the placement of parentheses for reduce
            ...
            if (found === true) {
                ...
                // FIXED: Changed 'key' to 'matchingRoom' to match your variable
                console.log("messages", matchingRoom, ":", sender, data);

                // FIXED: Corrected the syntax for forEach
        ...
        socket.on("disconnect", () => {
            ...
            // FIXED: Cleaned up the nested loops for finding the room key
